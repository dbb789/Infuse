...
namespace Infuse.TypeInfo
{
    public class InfuseTypeInfo
    {
        ...
        public TypeSet ProvidedServices => _providedServices;
        public TypeSet RequiredServices => _requiredServices;

        private readonly Type _instanceType;
        
        private readonly TypeSet _providedServices;
        private readonly TypeSet _requiredServices;
                              ...
                              OnDefuseFunc defuseFunc)
        {
            ...
            _providedServices = new TypeSet(providedServices ?? Enumerable.Empty<Type>());
            _requiredServices = new TypeSet(infuseFunc.Dependencies);
